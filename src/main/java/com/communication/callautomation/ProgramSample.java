...
class Dataset {
    ...
    public Dataset(String correlationId, String callConnectionId) {
...
public class ProgramSample {
    ...
    public ResponseEntity<String> outboundCall() {
        // Dataset ids = createOutboundCall();
        // String callConnectionId = ids.callConnectionId;
        // String correlationId = ids.correlationId;
        
        // String blob = "https://acsbyoseurope.blob.core.windows.net/call-contain";
        ...
        // // RecordingStorageType recordingStorageType = RecordingStorageType.fromString("azureBlobStorage");
        StartRecordingOptions recordingOptions = new StartRecordingOptions(callLocator)
        .setRecordingChannel(RecordingChannel.MIXED)
        .setRecordingContent(RecordingContent.AUDIO_VIDEO)
        .setRecordingFormat(RecordingFormat.MP4)
        .setPauseOnStart(false)
        .setRecordingStorage(new AzureCommunicationsRecordingStorage());

        // //start recording
        RecordingStateResult result = callRecording.start(recordingOptions);
        String callRecordingId = result.getRecordingId();
        log.info("Call recording started with ID: {}", callRecordingId);

        return ResponseEntity.ok().body("Server callid");
    }
    ...
    private Dataset createOutboundCall() {
        try {
            ...
            return new Dataset(correlationId, callConnectionId);
    ...
    private String callRecording(final String callConnectionId) {
        try {
            ...
            startRecordingOptions.setPauseOnStart(true);
